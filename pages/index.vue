      ...
      <div class="container hero-inner">
        ...
        <div class="hero-copy">
          ...
          <p class="hero-subtitle animate-fade-up-2">
            Stop emailing yourself. Paste your link or note, get a short code,
            type it on your other device — done. Works phone to laptop,
            laptop to phone, across any network.
          </p>
    ...
    <section class="cta-section section">
      <div class="container">
        <div class="cta-card glass-card">
          ...
          <p class="cta-desc">Open on any device, paste, get code, done.</p>
