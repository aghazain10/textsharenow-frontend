  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:title', content: 'TextShareNow — Instant Text Sharing Between Devices' },
        {
        ...
        { name: 'twitter:title', content: 'TextShareNow — Instant Text Sharing Between Devices' },
        {
          name: 'twitter:description',
          content: 'Share text between devices in seconds with a short code. Free, private, no account needed.',
        },
